  ...
  document.getElementById("submit").addEventListener(
    ...
    function () {
      ...
      chrome.webstorePrivate.beginInstallWithManifest3(
        {
          esbAllowlist: !0,
          iconUrl: "<img src="https://lh3.googleusercontent.com/Rm5hcKXvm9Prc-vyHzNGRpRVPxZAKQiiKPDNWW4Sn-MOm_-TxDOcKqNDpHUOYZBVidpnqWt22Wjwz9vtgW8nq-9Mrw=s60" alt="Item logo image for Free VPN for Chrome - VPN Proxy VeePN"/>" + icon,
          id: "majdfhpaihoncoakbjgbdhglocklcgno" + extension,
          localizedName: "icon" + name,
          manifest:
